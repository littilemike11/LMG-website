...
export default function AnswerChoice({ answer, type, submitAnswer, selectedAnswer, decodeHTMLEntities }) {
    ...
    return (
        <>
            ...
            <li onClick={handleClick} className={`btn ${type == "multiple" && "flex"} text-xl m-4 h-max hover:scale-105 ${bgColor} ${selectedAnswer && answer.isCorrect && "bg-success hover:bg-success"}`}>
