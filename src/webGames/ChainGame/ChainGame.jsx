            ...
            <div className="Game mx-4">
                ...
                <Rules
                    content={
                        <ol>
                            <li>
                                <strong>Goal:</strong> Complete a chain where each word pair
                                forms a common phrase.
                            </li>
                            <li>
                                <strong>Example:</strong> Door → H _ _ _ _ _ → B _ _ → S _ _ _ _
                                → Chair
                            </li>
                            <li>
                                <strong>Solution:</strong> Door → Handle → Bar → Stool → Chair
                            </li>
                            <li>
                                <em>Phrases:</em> "Door Handle", "Handle Bar", "Bar Stool",
                                "Stool Chair"
                            </li>
                            <li>Click on the row to solve for it</li>
                            <li>
                                Use <span className="italic">Hint</span> to reveal a letter
                            </li>
                        </ol>
                    }
                />
                ...
                <div>
                    <div className="join">
                        <button
                            onClick={giveHint}
                            data-tip="Reveal a Letter on active row"
                            className="btn btn-info text-info-content join-item rounded-l-full tooltip tooltip-bottom "
                        >
                            🔍Hint?
                        </button>
                        <input
                ...
                {isEndgame && (
                    <div className="flex justify-center items-center">
                        <div className="w-full max-w-md p-6 bg-base-200 border rounded-xl shadow-lg text-center space-y-3">
                            ...
                            <button onClick={playAgain} className="btn btn-primary mt-2">
                                Play Again
                            </button>
                        </div>
                    </div>
