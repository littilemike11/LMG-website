...
export default function GameCarousel({ catalogue, setActiveGame }) {
    ...
    return (
        <>
            <div className="mx-2">
                <div className=" carousel carousel-center bg-neutral rounded-box w-96 sm:w-full max-w-lg md:max-w-xl lg:max-w-2xl xl:w-2/3 xl:max-w-3xl space-x-10 p-4 m-4">
                    {
